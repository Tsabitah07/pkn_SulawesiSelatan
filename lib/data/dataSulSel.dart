  ...
  final sulSelData = SulSelData(
    ...
    ekonomi: Ekonomi(
      ...
      ekonomi2: Aspek(
        ...
        kontribusiEkonomi:
            "PDB (Produk Domestik Bruto), Pendapatan, Pekerjaan, Ekspor dan Pengembangan infrastruktur dan teknologi ",
        deskripsi: "Meskipun berbatasan dengan Laut Sulawesi, pertanian di Sulawesi Selatan tetap menjadi sektor ekonomi utama karena lahan subur, ketersediaan air, mata pencaharian tradisional, keanekaragaman produk, pasar dalam negeri dan ekspor, potensi agribisnis, serta dukungan pemerintah.",
      ),
      ekonomi3: Aspek(
        nmAspek: "Pariwisata",
        ...
        kontribusiEkonomi:
            "Ini termasuk pilar utama, dan peluang jangka panjang bagi masyarakat dan lingkungan, dan menciptakan lapangan kerja, trmasuk perhotelan, kuliner dan pemandu wisata",
        deskripsi: "Pariwisata di Sulawesi Selatan adalah sektor utama karena pantai-pantai indah, ekosistem bawah laut yang kaya, budaya dan sejarah, pariwisata alam, infrastruktur pendukung, potensi berkelanjutan, serta kontribusi ekonomi yang besar.",
      ),
    ),
